...
public class SecurityConfig {
    ...
    public SecurityFilterChain publicSecurityFilterChain(HttpSecurity http) throws Exception {
        http
                .securityMatcher("/api/auth/**", "/api/products/**", "/api/categories/**", "/uploads/**", "/api/images/**", "/camunda/**", "/api/reviews/**", "/api/contact/**")
    ...
    public SecurityFilterChain privateSecurityFilterChain(HttpSecurity http) throws Exception {
        http
                .securityMatcher("/api/profile", "/camunda/**", "/api/orders/**", "/api/dashboard/**", "/api/cart/**", "/api/reports/products/**", "/api/users/**", "/api/reviews/**", "/api/contact/**")
                .authorizeHttpRequests(authorize -> authorize
